...
public class GraphNode
{
  ...
  {
    this(tile1, tile2, tile3, row, col, isWall, nodeTile);
    neighbors.add(tile4);
    neighbors.add(tile5);
  }
  ...
  public GraphNode(Tile tile1, Tile tile2, Tile tile3, Tile tile4, Tile tile5,
      ...
      Tile nodeTile)
  {
    this(tile1, tile2, tile3, tile4, tile5, row, col, isWall, nodeTile);
    neighbors.add(tile6);
    neighbors.add(tile7);
    neighbors.add(tile8);
   ...
   * @param tile8
   */
  private void checkTiles(Tile tile1, Tile tile2, Tile tile3, Tile tile4,
